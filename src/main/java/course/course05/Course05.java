...
//      equivalent for. Este un for each
//   tipElemList numeVariabila : numeLista
        for (Person p: people) //    asignam fiecare element din people intr-o variabila de tip Person care se numeste p
